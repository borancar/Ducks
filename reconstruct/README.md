...
| --- | --- |
| [`game.c`](game.c) | twenty functions: `close_egg_files`, `input_poll`, `make_rect`, `particles`, `draw_entities`, `show_resource_loop`, `draw_number`, `egg_load_pass_0x48`, `show_resource`, `draw_number2`, `cutscene_welcome_home`, `cutscene_photos`, `show_splash`, `episode_end_gate`, `menu_screen_driver`, `game_main`, `scan_save_slots`, `save_settings`, `init`, `main` |
